...
create_ec2_instance() {
    ...
    # Ensure the INSTANCE_NAME variable is being passed correctly
    set +u
    echo "Instance name: $instance_name"  # Add this to debug
    set -u
...
main() {
    ...
    KEY_NAME="mykey"
    SUBNET_ID="subnet-01e908e53bbf64d90"
    SECURITY_GROUP_IDS="sg-053dfd140f8c7f15e"   
